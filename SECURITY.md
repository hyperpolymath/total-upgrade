...
| **PGP Key** | [Download Public Key](https://hyperpolymath.io/.well-known/pgp-key.asc) |
| **Fingerprint** | `[Contact security@hyperpolymath.io for key]` |

```bash
# Import our PGP key
curl -sSL https://hyperpolymath.io/.well-known/pgp-key.asc | gpg --import
...
When using TotalUpdate & DNFinition, we recommend:
...
*Thank you for helping keep TotalUpdate & DNFinition and its users safe.* 🛡️
